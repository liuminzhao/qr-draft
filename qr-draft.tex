...
\begin{figure}[h]
  \begin{minipage}{0.5\linewidth}
    \centerline{\includegraphics[scale=0.4]{../bqrpt/data/change-age}}
  \end{minipage}
  \begin{minipage}{0.5\linewidth}
    \centerline{\includegraphics[scale=0.4]{../bqrpt/data/change-race1}}
  \end{minipage}
...
\begin{figure}[htbp]
  \begin{minipage}{0.5\linewidth}
    \centerline{\includegraphics[scale=0.4]{../bqrpt/data/hist-res}}
  \end{minipage}
  \begin{minipage}{0.5\linewidth} 
    \centerline{\includegraphics[scale=0.4]{../bqrpt/data/density-res}}
  \end{minipage}
