...
candidate distribution $\sigma^c \sim \LN(\log \sigma^{l-1},
t_{\sigma})$. The same strategy is applied for \polya{} tree weight
parameter $c$, where $c^c \sim \LN(\log c^{l-1}, t_c)$.
...
When considering heterogeneity in model 1 (M1H), PT and PTSS performs as well as FBQR and better than RQ.
