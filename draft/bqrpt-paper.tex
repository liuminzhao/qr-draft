...
from FBQR method for certain quantiles of interest.  We also expect to
...
crossing quantile lines for both simulated data and real data
set. However, quantile lines from our method cannot cross since
...
our method only needs one model to fit all and avoid crossing quantile
curves, while FBQR and RQ need separate models assuming different
error distribution for each quantile regression.  We also applied and
