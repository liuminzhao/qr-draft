#!/bin/Rscript
##' Time-stamp: <liuminzhao 08/31/2013 17:25:41>
...
write.table(result, file="sim-m5-result-0831.txt", row.names = F, col.names = F)
sendEmail(subject = "simulation-m5", text = "done", address = "liuminzhao@gmail.com")
...
## TRUE VALUE
###############
result <- read.table('sim-m5-result-0831.txt')
pMN.5 <- function(x){
