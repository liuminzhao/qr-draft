#!/bin/Rscript
##' Time-stamp: <liuminzhao 04/22/2014 00:51:44>
##' 2013/08/31 simulation M1
##' 2013/09/03 new

sink('sim-m5-0422.txt')
rm(list = ls())
library(bqrpt)
library(quantreg)
library(xtable)
...
write.table(result, file="sim-m5-result-0422.txt", row.names = F, col.names = F)
...
## TRUE VALUE
###############
result <- read.table('sim-m5-result-0422.txt')
