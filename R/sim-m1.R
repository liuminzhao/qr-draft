...
write.table(result, file="sim-m1-result-0422.txt", row.names = F, col.names = F)
...
## TRUE VALUE
###############
result <- read.table('sim-m1-result-0422.txt')
truebetatau5 <- c(1,1)
