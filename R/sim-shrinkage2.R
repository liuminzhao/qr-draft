...
write.table(result, file="sim-shrinkage-2-result-1008.txt", row.names = F, col.names = F)
...
## TRUE VALUE
###############
result <- read.table('sim-shrinkage-2-result-1008.txt')
truebetatau5 <- c(1, 1, 0)
truebetatau9 <- c(1+qt(0.9, df = 3),1, 0)
